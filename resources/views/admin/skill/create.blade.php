...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h1 class="page-title mb-0">Tambah Skill</h1>
</div>
...
<div class="card-dark" style="max-width:640px;">
    <form method="POST" action="{{ route('admin.skill.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control-adm" placeholder="Contoh: Laravel, Vue.js, Figma..." value="{{ old('name') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="icon" class="form-control-adm" placeholder="Contoh: bi bi-filetype-php" value="{{ old('icon') }}">
        ...
        <div class="mb-3">
            <label class="form-label-adm">Level Keahlian: <span id="levelVal" style="color:var(--primary);font-weight:700;">{{ old('level', 75) }}%</span></label>
            <input type="range" name="level" id="levelRange" min="0" max="100" value="{{ old('level', 75) }}"
        ...
        <div class="d-flex gap-2">
            <button type="submit" class="btn-primary-adm">
                <i class="bi bi-check-lg me-1"></i> Simpan Skill
            </button>
