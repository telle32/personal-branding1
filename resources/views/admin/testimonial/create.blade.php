...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h1 class="page-title mb-0">Tambah Testimoni</h1>
</div>
    ...
    <form action="{{ route('admin.testimonial.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="content" rows="4" class="form-control-adm @error('content') is-invalid @enderror"
                      placeholder="Tuliskan testimoni dari klien...">{{ old('content') }}</textarea>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                ...
                <input type="number" name="order" class="form-control-adm" value="{{ old('order', 0) }}" min="0">
            </div>
        ...
        <div class="d-flex gap-3">
            <button type="submit" class="btn-primary-adm border-0">
                <i class="bi bi-check-lg me-1"></i> Simpan Testimoni
            </button>
